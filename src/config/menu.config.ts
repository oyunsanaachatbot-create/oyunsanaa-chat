...
export type MenuItem = {
  ...
  label: string;
  href: string;
  isApp?: boolean; // ✅ бүлэг бүрийн хамгийн доорх app
};
...
export const MENU_CONFIG: MenuGroup[] = [
  {
    ...
    items: [
      ...
      { id: "daily-check", label: "Өнөөдрийн сэтгэл санаа апп", href: "/mind/emotion/control/daily-check", isApp: true },
    ],
  },
  {
    ...
    items: [
      ...
      { id: "ebooks", label: "Миний ертөнц · Тэмдэглэл апп", href: "/mind/ebooks", isApp: true },
    ],
  },
  {
    id: "relationships",
    ...
    items: [
      ...
      { id: "relations-app", label: "Харилцааны апп", href: "/mind/relations/app", isApp: true },
    ],
  },
  {
    id: "lifePurpose",
    ...
    items: [
      ...
      { id: "purpose-app", label: "Зорилго апп", href: "/mind/purpose/app", isApp: true },
    ],
  },
  {
    id: "selfCare",
    ...
    items: [
      ...
      { id: "health-app", label: "Эрүүл мэнд апп", href: "/mind/self-care/app", isApp: true },
    ],
  },
  {
    id: "life",
    ...
    items: [
      ...
      { id: "work-stress", label: "Ажлын стресс ба орчин", href: "/mind/life/work-stress" },
      ...
      { id: "finance-app", label: "Миний санхүү (Бүртгэл)", href: "/mind/life/finance-app" },
      { id: "life-app", label: "Миний санхүү апп", href: "/mind/life/app", isApp: true },
    ],
  },
];
