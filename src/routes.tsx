// src/lib/navigation/routes.tsx (эсвэл /src/routes.tsx)
// ✅ Зөвхөн чиний меню (Mind) — Horizon sidebar-д шууд гарна.

import { Icon } from "./lib/chakra"; // хэрвээ энэ зам чинь өөр бол өөрийнхөөрөө үлдээгээрэй
...
const routes: IRoute[] = [
  {
    ...
    path: "/mind",
    icon: (
      <Icon as={MdOutlinePsychology} width="20px" height="20px" color="inherit" />
    ),
    collapse: true,
    items: [
      // 1) Emotion Control
      ...
      // 2) Self Understanding
      {
        ...
        layout: "/mind",
        path: "/self",
        icon: <Icon as={MdOutlinePsychology} width="18px" height="18px" color="inherit" />,
        collapse: true,
        items: [
      ...
      // 3) Relationships
      {
        ...
        layout: "/mind",
        path: "/relations",
        icon: <Icon as={MdFavorite} width="18px" height="18px" color="inherit" />,
        collapse: true,
        items: [
      ...
      // 5) Self Care
      {
        ...
        layout: "/mind",
        path: "/self-care",
        icon: <Icon as={MdHealthAndSafety} width="18px" height="18px" color="inherit" />,
        collapse: true,
        items: [
