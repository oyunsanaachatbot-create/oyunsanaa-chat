...
export async function POST(req: Request) {
  try {
    ...
    const supabase = createClient(
      ...
      {
        global: {
          headers: { Authorization: authHeader }, // ✅ RLS + getUser бүгд ажиллана
        },
      }
    );

    // ✅ Logged-in user (token-оор)
    ...
    // ✅ image байвал last user msg-г rich content болгоно
